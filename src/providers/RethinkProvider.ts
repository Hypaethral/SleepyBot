...
// import { RDb, Operation } from 'rethinkdbdash';
// const r: RDb = require('../db');

// /**
//  * Uses a RethinkDB database to store settings with guilds
//  * @extends {SettingProvider}
//  */
// class RethinkProvider extends SettingProvider {
// 	/**
...
// 	 * @private
// 	 */
//     insertOrReplaceStmt: Operation<WriteResult>;

// 	/**
// 	 * Prepared statement to delete a settings row
// 	 * @private
// 	 */
//     deleteStmt: Operation<WriteResult>;
...
// 	/**
// 	 * @param connectionOptions - Options for the Database
// 	 */
//     constructor() {
//         super();
//         this.client = undefined;
//         this.listeners = new Map();
//         this.insertOrReplaceStmt = undefined;
