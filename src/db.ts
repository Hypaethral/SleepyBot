import Config = require('./config/local');
import {RDash} from 'rethinkdbdash';
const r: RDash = require('rethinkdbdash')({ servers: Config.rethink });
            ...
            return async function () {
                ...
                try {
                    const method_ = method.bind({
                        table: r.db(Config.rethink.dbPrefix + dbPostfix).table(tableName)
                    });
